...
$(function() {
	...
	function init() {
		...
		var g = [
			...
			new Point(200, 60, 0.0, 7, "#b1ebc3"),
			new Point(200, 75, 0.0, 8, "#b1ebc3"),
			new Point(200, 90, 0.0, 8, "#a7ecbc"),
			new Point(200, 105, 0.0, 8, "#a7ecbc"),
			new Point(200, 120, 0.0, 9, "#a7ecbc"),
			new Point(225, 80, 0.0, 6, "#83eaa3"),
			new Point(235, 70, 0.0, 7, "#83eaa3"),
			new Point(245, 60, 0.0, 8, "#83eaa3"),
			new Point(215, 85, 0.0, 6, "#66de8b"),
			new Point(225, 90, 0.0, 6, "#66de8b"),
			new Point(235, 100, 0.0, 6, "#4fdc7a"),
			new Point(245, 110, 0.0, 7, "#4fdc7a"),
			new Point(255, 122, 0.0, 7, "#4fdc7a"), //K
